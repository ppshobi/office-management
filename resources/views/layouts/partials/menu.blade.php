<div class="sidebar">
    <div class="sidebar-inner">
                ...
                <div class="peer peer-greed">
                    <a class="sidebar-link td-n" href="/home">
                        <div class="peers ai-c fxw-nw">
                            ...
                            <div class="peer peer-greed">
                                <h5 class="lh-1 mB-0 logo-text">Drona Admin Console</h5>
                            </div>
                        </div>
                    </a>
                </div>
        ...
        <ul class="sidebar-menu scrollable pos-r">
            ...
            <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="javascript:void(0);">
                    <span class="icon-holder"><i class="c-teal-500  ti-user"></i></span>
                    <span class="title">Students</span>
                    <span class="arrow"><i class="ti-angle-right"></i></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="nav-item dropdown">
                        <a href="/student"><span>Manage Students</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="/student/create"><span>Add a Student</span></a>
                    </li>
                </ul>
            </li>
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li class="nav-item dropdown">
                        <a href="/staff"><span>Manage Staffs</span></a>
                    </li>
                    <li class="nav-item dropdown">
                        <a href="/staff/create"><span>Add a Staff</span></a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item dropdown">
                <a class="dropdown-toggle" href="javascript:void(0);">
                    <span class="icon-holder"><i class="c-deep-orange-500  ti-money"></i></span>
                    <span class="title">Transactions</span>
                    <span class="arrow"><i class="ti-angle-right"></i></span>
                </a>
                <ul class="dropdown-menu">
                    <li class="nav-item dropdown">
                        <a href="/transaction"><span>View Transactions</span></a>
                    </li>
                    <li class="nav-item dropdown">
